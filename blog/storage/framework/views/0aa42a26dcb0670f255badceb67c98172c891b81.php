    ...
    <ul class="navbar-nav d-flex flex-row" style="margin-right:150px">
      ...
      <li class="nav-item" >
        <a class="nav-link" href="/cartlist" style="color:white">
          <span class="badge badge-pill bg-danger"><?php echo e($total); ?></span>
...
</nav><?php /**PATH C:\Users\Rubayet Anjum Joy\Desktop\Laravel Project\blog\resources\views/header.blade.php ENDPATH**/ ?>