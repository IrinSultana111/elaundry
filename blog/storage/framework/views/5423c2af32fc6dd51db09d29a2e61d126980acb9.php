...
.hello
{
  background-image: url(<?php echo e(URL('/')); ?>/img/login.jpg);
  background-size: 100%;
}
</style>

 <?php /**PATH C:\Users\Rubayet Anjum Joy\Desktop\Project Divide\Rest(part3)\elaundry\blog\resources\views/master.blade.php ENDPATH**/ ?>